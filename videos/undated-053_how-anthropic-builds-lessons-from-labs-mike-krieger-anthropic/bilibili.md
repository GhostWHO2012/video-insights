...
- **BV号**: BV1v6bG6vEeb
- **视频链接**: https://www.bilibili.com/video/BV1v6bG6vEeb/
- **发布时间**: 2026-09-08 13:27:48
- **UP主**: 通用人工智障
...
看点：
Mike Krieger 为什么从 Anthropic CPO 转到 Labs 做个人贡献者
为什么 AI 产品要鼓励用户提出更大的请求
一个周末把 Python 代码库迁移到 TypeScript 的经验
2010 年 Instagram 规模化经验在 AI 时代为什么仍然重要
在 Slack 里 @ Claude 带来的多人协作式任务委派
为什么代码评审的瓶颈正在从时间变成理解
Anthropic Labs 如何用两周节奏决定继续推进还是转向
Claude Design、Project Unship 与 AI 产品原语的下线
大模型公司高速迭代时，创业公司的垂直机会在哪里
高强度 AI 行业里如何面对倦怠和真实情绪
